...
const venues: VenueData[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    weeklySchedule: {
      tue: { name: "Miss Fish Tuesday", description: "Seafood and sounds", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "Mixed" },
      wed: { name: "Miss Fish Wednesday", description: "Mid-week seafood session", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "Mixed" },
      thu: { name: "Miss Fish Thursday", description: "Seafood Thursday", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "Mixed" },
      fri: { name: "Miss Fish Friday", description: "Friday feast", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "Mixed" },
      sat: { name: "Miss Fish Saturday", description: "Weekend dining", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "Mixed" },
    },
  ...
  },
  {
    ...
    tags: ["restaurant", "nightlife", "sunset", "brunch"],
    ...
    weeklySchedule: {
      tue: { name: "Desa Tuesday", description: "Tuesday sessions at the Head", isSpecial: true, startTime: "17:00", endTime: "00:00", genre: "Mixed" },
      fri: { name: "Desa Friday", description: "Friday sunset party", isSpecial: true, startTime: "17:00", endTime: "00:00", genre: "House" },
      sat: { name: "Sunset Sessions", description: "Curated DJ sets as the sun drops over the ocean", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "Electronic" },
      sun: { name: "Sunday Brunch Party", description: "Extended brunch with live music and pool access", isSpecial: true, startTime: "11:00", endTime: "00:00", genre: "Mixed" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Pool Party", description: "Daytime pool party with international DJs", isSpecial: true, startTime: "14:00", endTime: "02:00", genre: "Electronic" },
      sat: { name: "Main Event", description: "International DJ headliners and full production", isSpecial: true, startTime: "15:00", endTime: "02:00", genre: "Electronic" },
      sun: { name: "Sunday Sessions", description: "Chilled beats and pool vibes to close the weekend", isSpecial: true, startTime: "13:00", endTime: "02:00", genre: "House" },
    },
  ...
  },
  {
    ...
    area: VenueArea.CANGGU,
    category: VenueCategory.BEACH_CLUB,
    tags: ["pool-party", "brunch", "nightlife"],
    address: "Jl. Pantai Berawa, Canggu, Bali",
    latitude: -8.6575,
    longitude: 115.1420,
    priceRange: 3,
    ...
    openingHours: BEACH_CLUB_HOURS,
    weeklySchedule: {
      fri: { name: "Friday Fiesta", description: "Poolside party with guest DJs and fire dancers", isSpecial: true, startTime: "14:00", endTime: "00:00", genre: "House" },
      sat: { name: "Pool Party", description: "All-day pool party with premium sound", isSpecial: true, startTime: "12:00", endTime: "00:00", genre: "Electronic" },
      sun: { name: "Recovery Sunday", description: "Chilled afternoon sessions with acoustic sets", isSpecial: true, startTime: "13:00", endTime: "00:00", genre: "Chill" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      wed: { name: "Bohemian Night", description: "Live acoustic music and boho vibes on the sand", isSpecial: true, startTime: "17:00", endTime: "00:00", genre: "Acoustic" },
      sat: { name: "Beach Party", description: "DJ sets and dancing under the stars", isSpecial: true, startTime: "17:00", endTime: "00:00", genre: "House" },
      sun: { name: "Sunset Session", description: "Golden hour beats and seafood specials", isSpecial: true, startTime: "17:00", endTime: "00:00", genre: "Chill" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      mon: { name: "Monday Madness", description: "Cheap drinks and good vibes to start the week", isSpecial: true, startTime: "18:00", endTime: "02:00", genre: "Mixed" },
      wed: { name: "Trivia Night", description: "Pub quiz with prizes and Bintang specials", isSpecial: true, startTime: "18:00", endTime: "02:00", genre: "Mixed" },
      fri: { name: "Live Music", description: "Local and touring bands on the main stage", isSpecial: true, startTime: "18:00", endTime: "02:00", genre: "Live Music" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      thu: { name: "Rock Night", description: "Classic rock anthems and drink specials", isSpecial: true, startTime: "20:00", endTime: "02:00", genre: "Rock" },
      fri: { name: "Live Bands", description: "Touring and local bands playing live sets", isSpecial: true, startTime: "20:00", endTime: "02:00", genre: "Live Music" },
      sat: { name: "DJ Night", description: "Late-night DJ sets and party vibes", isSpecial: true, startTime: "20:00", endTime: "02:00", genre: "Mixed" },
    },
    phone: "",
    website: "",
  ...
  },
  {
    ...
    openingHours: BEACH_CLUB_HOURS,
    weeklySchedule: {
      thu: { name: "Sunset Drinks", description: "Golden hour cocktails with ocean views", isSpecial: true, startTime: "16:00", endTime: "23:00", genre: "Chill" },
      sat: { name: "Beach BBQ", description: "Live BBQ on the sand with DJ sets", isSpecial: true, startTime: "16:00", endTime: "23:00", genre: "Mixed" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Art & Beats", description: "Gallery exhibition opening with DJ sets", isSpecial: true, startTime: "20:00", endTime: "02:00", genre: "Electronic" },
      sat: { name: "Gallery Night", description: "Art-meets-nightlife with visual installations and music", isSpecial: true, startTime: "20:00", endTime: "02:00", genre: "Electronic" },
    },
    phone: "",
    website: "",
  ...
  },
  {
    ...
    openingHours: BEACH_CLUB_HOURS,
    weeklySchedule: {
      fri: { name: "Sunset Sessions", description: "Refined sunset cocktails with resident DJ", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "House" },
      sat: { name: "Beach Club Night", description: "Upscale evening party with curated music", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "Electronic" },
    },
    phone: "",
    website: "",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    weeklySchedule: {
      mon: { name: "Bella Monday", description: "EDM night — tables clear, bass drops", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "EDM" },
      wed: { name: "Bella Wednesday", description: "Mid-week EDM session", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "EDM" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    openingHours: { mon: "11:00-00:00", tue: "11:00-00:00", wed: "11:00-00:00", thu: "11:00-00:00", fri: "11:00-00:00", sat: "11:00-00:00", sun: "11:00-00:00" },
    weeklySchedule: {
      mon: { name: "Luigi Monday", description: "Popular music night — the week starts here", isSpecial: true, startTime: "19:00", endTime: "00:00", genre: "Pop" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    weeklySchedule: {
      mon: { name: "Mesa Monday", description: "Afro night", isSpecial: true, startTime: "23:00", endTime: "04:00", genre: "Afrobeats" },
      tue: { name: "Mesa Tuesday", description: "Afro sessions", isSpecial: true, startTime: "23:00", endTime: "04:00", genre: "Afrobeats" },
      wed: { name: "Mesa Wednesday", description: "Mid-week Afro", isSpecial: true, startTime: "23:00", endTime: "04:00", genre: "Afrobeats" },
      thu: { name: "Mesa Thursday", description: "Afro night", isSpecial: true, startTime: "23:00", endTime: "04:00", genre: "Afrobeats" },
      fri: { name: "Mesa Friday", description: "Weekend Afro party", isSpecial: true, startTime: "23:00", endTime: "04:00", genre: "Afrobeats" },
      sat: { name: "Mesa Saturday", description: "Main night — full house", isSpecial: true, startTime: "23:00", endTime: "04:00", genre: "Afrobeats" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    weeklySchedule: {
      tue: { name: "Shady Pig Tuesday", description: "EDM night", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "EDM" },
      wed: { name: "Shady Pig Wednesday", description: "Electronic sessions", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "EDM" },
      thu: { name: "Shady Pig Thursday", description: "EDM night", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "EDM" },
      fri: { name: "Shady Pig Friday", description: "Weekend warm-up", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "EDM" },
      sat: { name: "Shady Pig Saturday", description: "Main night", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "EDM" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Morabito Friday", description: "R&B and hip-hop beach party", isSpecial: true, startTime: "12:00", endTime: "02:00", genre: "R&B / Hip Hop" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    weeklySchedule: {
      sun: { name: "Amavi Sunday", description: "The Sunday closer — EDM all night", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "EDM" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    openingHours: { mon: "21:00-04:00", tue: "21:00-04:00", wed: "21:00-04:00", thu: "21:00-04:00", fri: "21:00-04:00", sat: "21:00-04:00", sun: "21:00-04:00" },
    weeklySchedule: {
      sun: { name: "Back Room Sunday", description: "R&B and hip-hop session", isSpecial: true, startTime: "22:00", endTime: "04:00", genre: "R&B / Hip Hop" },
    },
    phone: "",
    website: "",
    instagram: "",
  },
  {
    ...
    weeklySchedule: {
      thu: { name: "Jade Thursday", description: "Hip-hop night — the original", isSpecial: true, startTime: "19:00", endTime: "02:00", genre: "R&B / Hip Hop" },
    },
    phone: "",
    website: "",
    instagram: "",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    weeklySchedule: {
      sat: { name: "Sardine Saturday", description: "Fine dining at its finest — book ahead", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Fine Dining" },
    },
    phone: "",
    website: "",
    instagram: "",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    weeklySchedule: {
      sat: { name: "Il Salotto Saturday", description: "Dinner turns to party on the cliffs", isSpecial: true, startTime: "18:00", endTime: "01:00", genre: "House" },
      sun: { name: "Il Salotto Sunday", description: "Sunday sessions", isSpecial: true, startTime: "18:00", endTime: "01:00", genre: "Chill House" },
    },
    phone: "",
    website: "",
    instagram: "",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    weeklySchedule: {
      sat: { name: "Major International DJs", description: "World-class headliners in the clifftop amphitheatre", isSpecial: true, startTime: "14:00", endTime: "04:00", genre: "Electronic" },
      sun: { name: "Sunday Session", description: "The big day -- extended afternoon into evening with top DJs", isSpecial: true, startTime: "14:00", endTime: "04:00", genre: "Electronic" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Spanish Night", description: "Flamenco, paella, and sangria on the cliffs", isSpecial: true, startTime: "18:00", endTime: "00:00", genre: "Dining" },
      sat: { name: "Seafood Feast", description: "Multi-course seafood dinner with ocean views", isSpecial: true, startTime: "18:00", endTime: "00:00", genre: "Dining" },
      sun: { name: "Sunday Brunch", description: "Extended brunch with free-flow drinks and live music", isSpecial: true, startTime: "18:00", endTime: "00:00", genre: "Mixed" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      sat: { name: "Beach Day Party", description: "All-day beach party in the secluded cove", isSpecial: true, startTime: "10:00", endTime: "20:00", genre: "Chill" },
      sun: { name: "Sunday Chill", description: "Relaxed Sunday with acoustic music and snorkelling", isSpecial: true, startTime: "10:00", endTime: "20:00", genre: "Chill" },
    },
  ...
  },
  {
    ...
    openingHours: BEACH_CLUB_HOURS,
    weeklySchedule: {
      fri: { name: "Sunset Session", description: "Cliff-edge sunset drinks with DJ", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "House" },
      sat: { name: "Cliff Party", description: "Full-production party above the Indian Ocean", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "Electronic" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      mon: { name: "Open Mic", description: "Open mic night for musicians and comedians", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "Live Music" },
      wed: { name: "Surf Film Night", description: "Classic and new surf films on the big screen", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "Film" },
      sun: { name: "Sunday Sunset", description: "Legendary Sunday session -- live music, cheap drinks, surfer crowd", isSpecial: true, startTime: "16:00", endTime: "00:00", genre: "Live Music" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      sat: { name: "Pool Party", description: "Glass-bottom pool party with cocktails and ocean views", isSpecial: true, startTime: "12:00", endTime: "22:00", genre: "Chill" },
      sun: { name: "Recovery Brunch", description: "Luxury brunch with spa access and cliff views", isSpecial: true, startTime: "12:00", endTime: "22:00", genre: "Dining" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Opening Night", description: "Weekend kickoff with headline DJs and full production", isSpecial: true, startTime: "14:00", endTime: "04:00", genre: "Electronic" },
      sat: { name: "Main Event", description: "Peak night -- international DJ residencies and bottle service", isSpecial: true, startTime: "14:00", endTime: "04:00", genre: "Electronic" },
      sun: { name: "Pool Party", description: "Extended daytime pool party to close the weekend", isSpecial: true, startTime: "14:00", endTime: "04:00", genre: "House" },
    },
    phone: "+62 361 8482150",
  ...
  },
  {
    ...
    weeklySchedule: {
      sat: { name: "Beach Party", description: "Intimate cove party with DJ and Mediterranean food", isSpecial: true, startTime: "10:00", endTime: "20:00", genre: "Chill" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Farm Dinner", description: "Multi-course farm-to-table dinner with local produce", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Dining" },
      sat: { name: "Chef's Tasting", description: "Seasonal tasting menu with wine pairing", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Dining" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Live Music", description: "Live bands on the rocks with sunset cocktails", isSpecial: true, startTime: "16:00", endTime: "01:00", genre: "Live Music" },
      sat: { name: "Live Music", description: "Weekend live music sessions above the waves", isSpecial: true, startTime: "16:00", endTime: "01:00", genre: "Live Music" },
    },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    weeklySchedule: {
      fri: { name: "Sunset Session", description: "Iconic sunset cocktails with resident DJ on the beach", isSpecial: true, startTime: "11:00", endTime: "01:00", genre: "House" },
      sat: { name: "Beach Club Night", description: "Premium evening party with international DJs", isSpecial: true, startTime: "11:00", endTime: "01:00", genre: "Electronic" },
      sun: { name: "Sunday Brunch", description: "Legendary bottomless brunch with ocean views", isSpecial: true, startTime: "11:00", endTime: "01:00", genre: "Mixed" },
    },
    phone: "+62 361 736969",
  ...
  },
  {
    ...
    openingHours: BEACH_CLUB_HOURS,
    weeklySchedule: {
      sat: { name: "Sunset Sessions", description: "DJ sets by the pool as the sun goes down", isSpecial: true, startTime: "11:00", endTime: "00:00", genre: "Electronic" },
      sun: { name: "Sunday Brunch & Pool", description: "Extended brunch with pool access and live music", isSpecial: true, startTime: "11:00", endTime: "00:00", genre: "Mixed" },
    },
    phone: "+62 361 6207979",
    website: "https://potatohead.co",
    instagram: "@potatoheadbali",
  },
  {
    ...
    weeklySchedule: {
      wed: { name: "Ladies Night", description: "Free drinks for ladies 9-11pm -- Seminyak's best midweek party", isSpecial: true, startTime: "21:00", endTime: "04:00", genre: "Mixed" },
      fri: { name: "Jungle Party", description: "Multi-room madness in the jungle-themed venue", isSpecial: true, startTime: "21:00", endTime: "04:00", genre: "Electronic" },
      sat: { name: "Main Night", description: "The biggest party in Seminyak -- packed rooms and top DJs", isSpecial: true, startTime: "21:00", endTime: "04:00", genre: "Electronic" },
    },
    phone: "+62 361 738108",
  ...
  },
  {
    ...
    weeklySchedule: {
      sat: { name: "Pool Party", description: "All-day pool party with DJs, diving board, and cocktails", isSpecial: true, startTime: "11:00", endTime: "21:00", genre: "House" },
      sun: { name: "Sunday Splash", description: "Chilled Sunday pool session with brunch menu", isSpecial: true, startTime: "11:00", endTime: "21:00", genre: "Chill" },
    },
    phone: "+62 361 737804",
  ...
  },
  {
    ...
    weeklySchedule: {
      tue: { name: "Taco Tuesday", description: "Half-price tacos, frozen margaritas, and Latin beats", isSpecial: true, startTime: "17:00", endTime: "02:00", genre: "Latin" },
      thu: { name: "Mezcal Night", description: "Mezcal cocktail specials with Mexican street food", isSpecial: true, startTime: "17:00", endTime: "02:00", genre: "Mixed" },
      sat: { name: "Fiesta", description: "Full-blown Mexican party with DJs and tequila", isSpecial: true, startTime: "17:00", endTime: "02:00", genre: "Latin" },
    },
    phone: "+62 361 736688",
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Asian Fusion Night", description: "Chef's special multi-course Asian tasting menu", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Dining" },
      sat: { name: "Chef's Table", description: "Intimate chef's table experience with wine pairing", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Dining" },
    },
  ...
  },
  {
    ...
    openingHours: { ...RESTAURANT_HOURS, mon: "12:00-23:00", tue: "12:00-23:00", wed: "12:00-23:00", thu: "12:00-23:00", fri: "12:00-00:00", sat: "12:00-00:00", sun: "12:00-23:00" },
    weeklySchedule: {
      thu: { name: "Cocktail Evening", description: "Craft cocktail masterclass with bar snacks", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Dining" },
      sat: { name: "Street Food Night", description: "Southeast Asian street food tasting menu", isSpecial: true, startTime: "18:00", endTime: "23:00", genre: "Dining" },
    },
    phone: "+62 361 730436",
  ...
  },
  {
    ...
    weeklySchedule: {
      fri: { name: "Steak Night", description: "Premium cuts, open-fire grill, and red wine specials", isSpecial: true, startTime: "18:00", endTime: "00:00", genre: "Dining" },
      sat: { name: "BBQ & Beats", description: "Live fire BBQ with DJ sets in the courtyard", isSpecial: true, startTime: "18:00", endTime: "00:00", genre: "Mixed" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      thu: { name: "Cocktail Night", description: "Craft cocktail specials with the W's mixologists", isSpecial: true, startTime: "17:00", endTime: "02:00", genre: "Mixed" },
      fri: { name: "DJ Night", description: "International and resident DJs by the pool", isSpecial: true, startTime: "17:00", endTime: "02:00", genre: "House" },
      sat: { name: "W Night", description: "The W's signature Saturday party -- dressed up and turned up", isSpecial: true, startTime: "17:00", endTime: "02:00", genre: "Electronic" },
    },
  ...
  },
  {
    ...
    weeklySchedule: {
      mon: { name: "Pizza Night", description: "Wood-fired pizza specials and Italian wines", isSpecial: true, startTime: "19:00", endTime: "02:00", genre: "Dining" },
      wed: { name: "Hip Hop Wednesday", description: "Tables get pushed aside, bass comes up -- Seminyak's best weekly party", isSpecial: true, startTime: "19:00", endTime: "02:00", genre: "Hip Hop" },
      fri: { name: "Italian Night", description: "Handmade pasta, aperitivo hour, and Italian beats", isSpecial: true, startTime: "19:00", endTime: "02:00", genre: "Dining" },
    },
