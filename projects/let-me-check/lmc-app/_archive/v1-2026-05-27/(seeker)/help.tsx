...
const FAQS = [
  { q: 'What is Let Me Check?', a: 'Order a real 30-second video of any place from a real person nearby. Delivered in 7-10 minutes. From $15.' },
...
const styles = StyleSheet.create({
  ...
  faqRow: { padding: 16 },
  faqRowBorder: { borderBottomWidth: 1, borderBottomColor: '#1a1a1a' },
  faqQ: {
  ...
  contactRowBorder: { borderBottomWidth: 1, borderBottomColor: '#1a1a1a' },
  ...
  devRowBorder: { borderBottomWidth: 1, borderBottomColor: '#1a1a1a' },
  devLabel: {
