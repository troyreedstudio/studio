  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        {/* Location Indicator — replaces decorative city pills */}
        <View style={styles.locIndicator}>
          <Text style={styles.locPin}>📍</Text>
          <Text style={styles.locCity}>Miami</Text>
          <Text style={styles.locDot}>·</Text>
          <View style={styles.locScoutDot} />
          <Text style={styles.locScouts}>142 Scouts active here</Text>
        </View>
